...
if not maps['load_maps']:
    ...
    if 'GC' in probe_selection['probes'] or 'GGL' in probe_selection['probes']:
        ...
        tomo_bins_lens, ngal_bins_lens, z_edges_lens = al.create_redshift_bins_simu(in_out['catalog_lens'],
                                                    columns_lens,
    ...
    if 'WL' in probe_selection['probes'] or 'GGL' in probe_selection['probes']:
        print(probe_selection['probes'])
        tomo_bins_source, ngal_bins_source, z_edges_source = al.create_redshift_bins_simu(in_out['catalog_source'],
                                                    columns_source,
                                                    z_binning['selected_bins'],
                                                    'source',
                                                    z_binning['division'],
