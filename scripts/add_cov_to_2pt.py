...
twopoint_file = '/Users/sgouyoub/Documents/work/euclid/nlbias/data/SDV/30deg_6EP_3x2_linbias_fsky_SDV.fits'
data = twopoint.TwoPointFile.from_fits(twopoint_file, covmat_name=None)
# data = twopoint.TwoPointFile.from_fits(twopoint_file)

# cov_file = '/Users/sgouyoub/Documents/work/euclid/nlbias/data/covariance/FS2_30deg_3x2_6EP_noIA-nomag-nored-nowh_sharpcut_covariance_nmt_coupled_NS1024_LBINlog_LMIN10_LMAX1500_NELL32.npy'
